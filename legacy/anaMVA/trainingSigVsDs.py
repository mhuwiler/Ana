...
parser.add_argument("-o", "--outpath", dest="outputpath", action="store", type=str, default="testDs", help="The utput path")
...
features_save = [("b_D0_pt", "F"), ("b_D0_eta", "F"), ("b_D0_phi", "F"), ("b_D0_vprob", "F"), ("b_D0_fl", "F"), ("b_D0_fsig", "F"), #("b_D0_fls", "F"),
	("b_Ds_pt", "F"), ("b_Ds_eta", "F"), ("b_Ds_phi", "F"), ("b_Ds_vprob", "F"), ("b_Ds_fl", "F"), ("b_Ds_fsig", "F"), #("b_Ds_fls", "F"), 
...
background = [samples["backgroundDs"]]
